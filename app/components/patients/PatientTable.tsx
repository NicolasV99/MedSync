    ...
    <>
      ...
      <div className="bg-white rounded-xl border border-neutral-border shadow-sm overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            {sorted.map((patient) => (
              <tr key={patient.patient_id} className="border-b border-neutral-border/60 last:border-none hover:bg-neutral-light/40 transition-colors">
                <td className="px-4 py-3 font-medium text-neutral-dark">{patient.patient_name}</td>
                <td className="px-4 py-3 text-neutral-gray">{patient.email ?? "-"}</td>
                <td className="px-4 py-3 text-neutral-gray">{patient.phone ?? "-"}</td>
                <td className="px-4 py-3 text-neutral-gray">{formatDate(patient.last_visit)}</td>
                ...
                <td colSpan={5} className="px-4 py-16 text-center">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-xs text-neutral-gray">
                      {search ? "Try a different name or email." : "Use Add Patient to create your first record."}
                    </p>
                  </div>
                </td>
              </tr>
